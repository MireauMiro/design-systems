...
import { Card, CardBody, CardImage, CardTitle, CardDescription, CardFooter, CardShadow, CardVersion } from '@/components/ui/card'
  ...
  render: () => (
    <Card>
      <CardBody>
        ...
        <CardFooter>
          <RobogearsButton color="cyan" variant="outline" size="sm" className="w-full justify-center">
            Button Text
          </RobogearsButton>
        </CardFooter>
      </CardBody>
    ...
    <div className="flex flex-col gap-6">
      ...
      <Card>
        <CardBody>
          ...
          <CardDescription>Here's some body copy for this damn card. This copy is a bit smaller since it's not a long form bit of content.</CardDescription>
          <CardFooter>
            <RobogearsButton color="cyan" variant="outline" size="sm" className="w-full justify-center">Button Text</RobogearsButton>
          </CardFooter>
        </CardBody>
        <CardShadow />
      </Card>
