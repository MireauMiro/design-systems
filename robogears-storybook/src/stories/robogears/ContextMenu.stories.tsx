...
const triggerClass = 'flex h-36 w-80 items-center justify-center rounded-[12px] border-2 border-dashed border-[hsl(191_100%_50%/0.3)] text-base font-medium text-[hsl(133_30%_45%)] select-none cursor-context-menu'
const triggerStyle = { fontFamily: 'JetBrains Mono' }
