  ...
  ({ side = 'left', className, children, ...props }, ref) => {
    ...
    return (
      <div
        ...
        data-open={isOpen}
        data-side={side}
        className={cn('relative flex flex-col shrink-0 bg-[hsl(130_14%_6.5%)] overflow-hidden transition-[width] duration-300 ease-in-out', className)}
        style={{
          width: isOpen ? SIDEBAR_WIDTH : SIDEBAR_WIDTH_COLLAPSED,
          borderRight: side === 'left' ? '2px solid hsl(191 100% 50% / 0.5)' : undefined,
          borderLeft: side === 'right' ? '2px solid hsl(191 100% 50% / 0.5)' : undefined,
    ...
    return (
      <button
        ...
        className={cn(
          ...
          'text-[hsl(133_70%_58%)] hover:bg-[#00D4FF]/10 hover:text-[#00D4FF]',
...
const SidebarHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn('flex flex-col justify-center shrink-0 h-14 border-b border-[hsl(191_100%_50%/0.18)]', className)} {...props} />
  )
)
...
const SidebarFooter = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn('flex flex-col shrink-0 border-t border-[hsl(191_100%_50%/0.18)]', className)} {...props} />
  )
)
...
const SidebarSeparator = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn('mx-3 my-1 h-px bg-[hsl(191_100%_50%/0.45)] shrink-0', className)} {...props} />
  )
)
...
const SidebarGroupLabel = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    ...
    return (
      <p
        ref={ref}
        className={cn('px-3 text-xs font-bold uppercase tracking-wide text-[hsl(133_30%_45%)] whitespace-nowrap', className)}
        style={{
          fontFamily: 'JetBrains Mono',
          overflow: 'hidden',
