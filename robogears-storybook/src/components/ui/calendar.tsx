...
function RoboGearsDayButton({ className, day, modifiers, ...props }: React.ComponentProps<typeof DayButton>) {
  ...
  return (
    <button
      ...
      className={cn(
        ...
        modifiers.selected
          ? 'bg-[#00D4FF] text-[#05121a] hover:bg-[#00b8e6]'
          : modifiers.today
          ? 'text-[#00D4FF] font-bold hover:bg-[#00D4FF]/10'
          : 'text-[hsl(133_70%_58%)] hover:bg-[#00D4FF]/10',
        (modifiers.outside) && !modifiers.selected && 'text-[hsl(133_18%_30%)]',
    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          'hover:bg-[#00D4FF]/10 text-[hsl(133_70%_58%)] transition-colors cursor-pointer',
        ...
        caption_label: cn('text-sm font-bold text-[hsl(133_70%_58%)]', defaultClassNames.caption_label),
        table: 'w-full border-collapse',
        weekdays: cn('flex', defaultClassNames.weekdays),
        weekday: cn(
          'w-[--cell-size] text-xs text-center font-medium text-[hsl(133_30%_45%)] pb-1',
